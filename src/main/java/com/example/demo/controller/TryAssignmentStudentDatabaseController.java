...
public class TryAssignmentStudentDatabaseController {
	...
	@GetMapping("/assignmentsDone")
	public List<?> findAssignmentsDone(){
		return service.findAssignmentsDone();
	}
	...
	public List<TryAssignmentStudentDatabase> getAll(@PathVariable("id") Long id){
		return service.getAllById(id);
	}
	
	@GetMapping("/score/{id}")
	public Long getScore(@PathVariable("id") Long id){
